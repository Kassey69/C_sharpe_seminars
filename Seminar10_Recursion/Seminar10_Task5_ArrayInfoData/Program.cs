...
int[] datanew = randomArray(data);
Console.WriteLine();
int [] randomArray(int data) 
{
...
// {
//     if (str[i] != '0' && str[i] != '1') // str[i] != '0' так отображаются одинарные символы
//     {
